...
from app.grandpy.skills.self_analysis import give_website_info
from app.grandpy.skills.tourist_guide import get_oc_anecdote, get_oc_coordinates, get_oc_address
from app.grandpy.skills.heads_tails import play_heads_or_tails